...
include_directories(${CMAKE_CURRENT_LIST_DIR}/EFM32TG/Include)

# Configure linker script and set linker script name
set(LINKER_SCRIPT_MASTER ${CMAKE_CURRENT_LIST_DIR}/EFM32TG/Source/GCC/${CPU_FAMILY_L}.ld)
...
set(STARTUP_FILE ${CMAKE_CURRENT_LIST_DIR}/EFM32TG/Source/GCC/startup_${CPU_FAMILY_L}.S)

# Set system file name
set(SYSTEM_FILE ${CMAKE_CURRENT_LIST_DIR}/EFM32TG/Source/system_${CPU_FAMILY_L}.c)
